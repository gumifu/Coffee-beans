      ...
      <section className="bg-coffee-50 py-16">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-coffee-100 hover:shadow-xl transition-all">
            <div className="h-48 rounded-xl overflow-hidden mb-6 bg-coffee-100">
               <img src="https://images.unsplash.com/photo-1517080319016-52c676d18a1a?q=80&w=600&auto=format&fit=crop" alt="Pour Over" className="w-full h-full object-cover" />
            </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-coffee-100 hover:shadow-xl transition-all">
            <div className="h-48 rounded-xl overflow-hidden mb-6 bg-coffee-100">
               <img src="https://images.unsplash.com/photo-1502421715651-7c98083833d7?q=80&w=600&auto=format&fit=crop" alt="French Press" className="w-full h-full object-cover" />
            </div>
          ...
          <div className="order-2 md:order-1">
           ...
           <div className="order-1 md:order-2 h-full">
             <img 
              ...
              alt="Pouring V60" 
              className="rounded-2xl shadow-2xl w-full h-[600px] object-cover sticky top-24"
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-coffee-900 text-coffee-50 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
           ...
           <div className="mt-12">
            <Link to="/" className="inline-block text-coffee-200 border-b border-coffee-200 pb-1 hover:text-white hover:border-white transition-colors">
