...
export default function Home() {
  // 3Dモデルを使用する場合は、public/models/フォルダにモデルファイルを配置し、
  // 以下のパスを指定してください（例: '/models/coffee-bean.glb'）
  // モデルがない場合は、自動的にフォールバック（Sphere）が表示されます
  const modelPath = process.env.NEXT_PUBLIC_MODEL_PATH || '/models/coffee_bean.glb';
    ...
    <div className="w-full overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/brew" className="bg-coffee-800 text-white px-8 py-4 rounded-full font-semibold hover:bg-coffee-900 transition-all flex items-center gap-2 shadow-xl shadow-coffee-900/10">
      ...
      <section className="py-24 bg-white/80 backdrop-blur-sm relative z-10">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="relative w-full h-64 rounded-2xl shadow-xl overflow-hidden mt-6 bg-coffee-200">
              <Image
      ...
      <section className="py-24 bg-coffee-50 relative z-10 text-center">
        <div className="max-w-2xl mx-auto px-6">
          ...
          <Link href="/brew" className="inline-flex items-center gap-2 bg-coffee-800 text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-coffee-900 hover:scale-105 transition-all shadow-xl">
